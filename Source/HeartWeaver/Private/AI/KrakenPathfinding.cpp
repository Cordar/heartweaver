...
TArray<FVector> KrakenPathfinding::GetPath(FVector StartPoint, FVector EndPoint, float GridDistance, TSet<FVector>* GridMap)
{
    ...
    while (OpenSet.Num() > 0)
    {
        ...
        TArray<FVector> Neighbors = GetNeighbors(CurrentNode->Position, GridDistance, GridMap);
