...
public:
	...
	void BindNativeAction(const UKDSInputConfig* InputConfig, const FGameplayTag& InputTag, ETriggerEvent TriggerEvent, UserClass* Object, FuncType
...
template<class UserClass, typename FuncType>
void UKDSInputComponent::BindNativeAction(const UKDSInputConfig* InputConfig, const FGameplayTag& InputTag, ETriggerEvent TriggerEvent, UserClass* Object, FuncType
                                          Func, bool bLogIfNotFound)
{
	check(InputConfig);
